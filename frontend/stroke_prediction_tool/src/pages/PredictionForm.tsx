...
const PredictionForm: React.FC = () => {
  ...
  return (
    <div className="page-fade-in" style={{ paddingBottom: '80px' }}>
      {/* Mini Header */}
      <div style={{ background: 'white', borderBottom: '1px solid var(--border-color)', padding: '20px 0', marginBottom: '40px' }}>
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer' }} onClick={() => navigate('/')}>
            <img src="/logo.png" alt="Logo" style={{ height: '32px' }} />
            <span style={{ fontSize: '1.25rem', fontWeight: 800, fontFamily: 'Outfit', color: 'var(--primary-color)' }}>NeuroGuard</span>
          </div>
      ...
      <div className="container">
        <div className="glass-panel" style={{ maxWidth: '900px', margin: '0 auto', padding: '0', overflow: 'hidden', background: 'white' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr' }}>
            {/* Left Sidebar Info */}
            <div style={{ background: 'var(--primary-color)', padding: '48px', color: 'white' }}>
              ...
              <p style={{ opacity: 0.9, fontSize: '0.95rem', lineHeight: 1.6 }}>
                Our AI engine analyzes physiological markers to determine statistical probability of stroke risk.
              </p>
              
              <div style={{ marginTop: '40px', display: 'grid', gap: '24px' }}>
                <div style={{ display: 'flex', gap: '16px' }}>
                  <div style={{ background: 'rgba(255,255,255,0.2)', width: '32px', height: '32px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>1</div>
                  <p style={{ fontSize: '0.9rem', margin: 0 }}>Fill in your accurate biometric data.</p>
                </div>
                <div style={{ display: 'flex', gap: '16px' }}>
                  <div style={{ background: 'rgba(255,255,255,0.2)', width: '32px', height: '32px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>2</div>
                  <p style={{ fontSize: '0.9rem', margin: 0 }}>AI processes metrics against clinical datasets.</p>
                </div>
                <div style={{ display: 'flex', gap: '16px' }}>
                  <div style={{ background: 'rgba(255,255,255,0.2)', width: '32px', height: '32px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>3</div>
                  <p style={{ fontSize: '0.9rem', margin: 0 }}>Get instant probability and risk factors.</p>
                </div>
              </div>

              <div style={{ marginTop: 'auto', paddingTop: '60px' }}>
                <div style={{ padding: '16px', background: 'rgba(0,0,0,0.1)', borderRadius: '12px', fontSize: '0.8rem', display: 'flex', gap: '12px' }}>
                  <Info size={20} />
